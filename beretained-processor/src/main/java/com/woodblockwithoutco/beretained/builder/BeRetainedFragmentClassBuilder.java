 ...
 */
public abstract class BeRetainedFragmentClassBuilder extends SuperBeRetainedFragmentAwareSaveRestoreClassBuilder {
    ...
    public BeRetainedFragmentClassBuilder(TypeMirror enclosingClassType, Messager m, Collection<TypeMirror> superRetainEnabledTypes, Types typeUtils) {
    ...
    protected TypeName getSuperTypeName() {
        ...
        //otherwise inherit from Fragment class that is determined by getFragmentTypeName().
        if(closestSuperBeRetainedFragment != null) {
            return closestSuperBeRetainedFragment;
        } else {
            return getFragmentTypeName();
        }
    }

    protected abstract TypeName getFragmentTypeName();
